...
<div>
        ...
        <table class="table table-nowrap">
            ...
            <tbody>
                <tr v-for="info in infos" v-bind:key="info.id">
                    <td>
                        <h5 class="font-size-13 mb-1 text-dark">{{info.information.company}}</h5>
                        <p class="font-size-12 text-muted mb-0">{{info.information.address}}</p>
                    </td>
                    <td class="text-center">
                        <h5 class="font-size-13 mb-1 text-dark">{{info.information.position}}</h5>
    ...
    <div class="modal fade exampleModal" id="newHistory" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <employment-history-create @status="status" :user="id" ref="history"></employment-history-create>
    </div>
</div>
</template>
    ...
    export default {
        ...
        methods : {
            ...
            fetch(page_url){
                ...
                page_url = page_url || this.currentUrl + '/request/information/History/'+this.id+'/'+this.counts;
            ...
            addnew(){
                $("#newHistory").appendTo("body").modal('show');
            },

                    ...
                    <table class="table table-centered table-nowrap">
                        <thead class="thead-light">
                            <tr>
                                ...
                                <th class="text-center">Grading System</th>
                                <th></th>
                            </tr>
                        </thead>
                        <tbody>
...
export default {
    ...
    methods: {
        ...
        fetch(page_url) {
            let vm = this; let key,t,g,c;
            (this.keyword != '' && this.keyword != null) ? key = this.keyword : key = '-';
            (this.term != '' && this.term != null) ? t = this.term : t = '-';
            (this.class != '' && this.class != null) ? c = this.class : c = '-';
            (this.grading != '' && this.grading != null) ? g = this.grading : g = '-';
            page_url = page_url || this.currentUrl + '/request/schools/'+this.counts+'/'+t+'/'+g+'/'+c+'/'+key;
